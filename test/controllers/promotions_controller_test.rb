...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { discount: @promotion.discount, end_date: @promotion.end_date, quantity: @promotion.quantity, start_date: @promotion.start_date } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { discount: @promotion.discount, end_date: @promotion.end_date, quantity: @promotion.quantity, start_date: @promotion.start_date } }
